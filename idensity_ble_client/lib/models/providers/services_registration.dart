...
import 'package:idensity_ble_client/services/modbus/modbus_service_impl.dart';
...
final measUnitServiceProvider = FutureProvider<MeasUnitService>((ref) async {
  ...
  final service = MeasUnitServiceImpl(measUnitRepository: repo);
  ref.onDispose(() {
    service.dispose();
  });
  await service.init();
...
final chartSettingsServiceProvider = FutureProvider<ChartsSettingsService>((
  ...
  final service = ChartsSettingsServiceImpl(
